...
} from "@/shared/animate-ui/primitives/radix/dropdown-menu";
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuHighlightItemPrimitive
      activeClassName={
        variant === "destructive" ? "bg-red-600/10 text-red-600" : ""
      }
      disabled={disabled}
    >
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          ...
          "[&:hover_svg]:text-accent-foreground [&:focus_svg]:text-accent-foreground",
